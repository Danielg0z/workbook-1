...
public class RentalCarCalc{
    ...
    public static void main(String[] args) {
        ...
        double basePrice = basePrice(numOfDays);

        //start options cost at 0, they dont have an options cost unless they pick options

        //genearate total options cost
        double optionsCost = calcoptionPrice(tollTag, gps, roadsideAssistance, numOfDays);
    ...
    public static double basePrice(int numDays){

        return 29.99 * numDays;

    }
    public static double calcoptionPrice(String tollTag, String gps, String roadsideAssistance, int numOfDays){
        //start options cost at 0, they dont have an options cost unless they pick options
